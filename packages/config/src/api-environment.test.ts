...
describe('loadApiConfig', () => {
  ...
  it('returns safe local defaults', () => {
    expect(loadApiConfig(requiredAuthEnvironment)).toEqual({
      ...
      host: '0.0.0.0',
      lahoreDeliveryFeeMinor: 0,
      lahoreDeliveryRateVersion: 'lahore-flat-v1',
      logFormat: 'pretty',
      listingImageBucket: 'listing-images',
      listingImageSignedUrlTtlSeconds: 900,
      localCourierEnabled: false,
      localCourierServiceCities: ['Lahore'],
      localCourierServiceCountryCode: 'PK',
